...
//It can access the variable because it's closed inside the function.
  ...
  */
  ...
  function lowerCaseNames(array){
    zooAnimals.map(function (array) {
        lowerCaseNames.push(array.animal_name.toLowerCase())
      });
...
CuboidMaker.prototype.volume = function(){
  return  CuboidMaker(this.length * this.width * this.height);
}
...
CuboidMaker.prototype.surfaceArea = function(){
  return CuboidMaker(2 * (this.length * this.width + this.length * this.height + this.width * this.height));
}
...
/* 🐴🐴🐴 Step 4: Create a new object that uses CuboidMaker 🐴🐴🐴
 ...
 class CuboidMakerTwo {
   ...
   surfaceArea () {
     return 2 * ((this.length * this.width) + (this.length * this. width));
   }
 }
